...
function print_help {
    echo "USAGE: private_key_extract.sh --storepath PATH_TO_JKS --storepass JKS_PASSWORD --keypass PRIVATE_KEY_PASSWORD --certalias CERTIFICATE_ALIAS --outname OUTPUT_NAME"
}
